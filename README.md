...
а также глобальная мультизадачная модель на основе DenseNet121 с двумя специализированными головами, обученная с использованием федеративного обучения (20 раундов, FedAvg с усреднением только весов бэкбона). 
...
каждый из которых будет иметь общий бэкбон и две головы, что полностью соответствует архитектуре, описанной в статье; 
